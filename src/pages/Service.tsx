					...
					<SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
						...
						<Stack my={6} data-aos="fade-left">
							...
							>
								...
								การสบฟันที่ไม่ดี รวมถึงความสัมพันธ์ของขากรรไกรฟัน และปัจจัยอื่น
								ๆ ซึ่งเป็นสาเหตุและปัญหาสำคัญที่ทำให้ความมั่นใจลดลง
					...
					<SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
						...
						<Stack my={6} data-aos="fade-left">
							...
							>
								...
								(ไม่เกิน 35,000 บาท) จัดฟันเสร็จก่อนจ่ายครบ ไม่ต้องชำระต่อ{" "}
								<br />
